...
public class FlightController {
	...
	public List<FlightModel> findByloc(@PathVariable("flightFrom") String flightFrom, @PathVariable("flightTo") String flightTo){
	
        logger.info("[findto/source/destination] info message added");
        logger.debug("[findto/source/destination] debug message added");
        
		return flightrepo.findByFlightFromAndFlightTo(flightFrom, flightTo);
	}
