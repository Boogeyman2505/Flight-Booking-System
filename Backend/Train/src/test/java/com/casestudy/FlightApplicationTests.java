...
class FlightApplicationTests {
	 ...
	 @Mock
	    ...
	    public void testFindByloc() {
	        ...
	        when(flightRepository.findByFlightFromAndFlightTo("Airport A", "Airport B")).thenReturn(flights);

	        // Calling the controller method
	        List<FlightModel> result = flightController.findByloc("Airport A", "Airport B");

	        // Verifying the repository method was called with the correct arguments
	        verify(flightRepository).findByFlightFromAndFlightTo("Airport A", "Airport B");
